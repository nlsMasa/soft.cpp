...
#include "ecore/impl/BasicEObjectMap.hpp"
...
namespace
{
    ...
    public:
        ...
        //            .with(
        //                [=]( const std::shared_ptr<ENotification>& n )
        //                {
...
BOOST_AUTO_TEST_SUITE( BasicEObjectMapTests )

BOOST_AUTO_TEST_CASE( Constructor )
{
    //auto object = std::make_shared<MockEObject>();
    //{
    //    BasicEObjectMap<> map( object, 0, 1 );
    //}
    //{
    //    BasicEObjectMap<false, true, false> map( object, 0, 1 );
    //}
    //{
    //    BasicEObjectMap<false, true, true> map( object, 0, 1 );
    //}
    //{
    //    BasicEObjectMap<false, false, false, false> map( object, 0, 1 );
    //}
    //{
    //    BasicEObjectMap<true, true, true, true> map( object, 0, 1 );
    //}
}
