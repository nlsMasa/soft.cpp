...
{
    auto notifier = std::make_shared<MockEObject>();
...
BOOST_AUTO_TEST_CASE( Merge )
{
    ...
    }
    {
        auto obj1 = std::make_shared<MockEObject>();
        auto obj2 = std::make_shared<MockEObject>();
        auto obj3 = std::make_shared<MockEObject>();
        auto notification = std::make_shared<Notification>(
            notifier, ENotification::REMOVE_MANY, feature, std::vector<Any>( {obj1, obj2} ), std::vector<std::size_t>( {2, 3} ) );
...
BOOST_AUTO_TEST_CASE( Add )
{
    ...
    }
    {
        ...
        auto obj2 = std::make_shared<MockEObject>();
        auto notification = std::make_shared<Notification>( notifier, ENotification::ADD, feature, NO_VALUE, obj1 );
        auto other = std::make_shared<MockENotification>();
        auto otherNotifier = std::make_shared<MockENotifier>();
